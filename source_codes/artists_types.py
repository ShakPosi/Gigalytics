...
class ArtistsTypes():
    ...
    def __extract(self):
        return self._db.extract_table_to_pandas("musicbrainz.artist_type", columns="id, name, parent, child_order")
    ...
    def __load(self, transformed_df):
        self._dw.load_df_into_dwh(transformed_df, "dim.artist_types", "public")
