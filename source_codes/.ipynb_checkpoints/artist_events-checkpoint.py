...
class ArtistEvents():
    ...
    def __extract(self):
        return self._db.extract_table_to_pandas("musicbrainz.l_artist_event", columns="id, entity0, entity1")
    
    def __transform(self, df):
        df["artist_id"] = df["entity0"]
    ...
    def __load(self, transformed_df):
        self._dw.load_df_into_dwh(transformed_df, "dim.artist_events", "public")
